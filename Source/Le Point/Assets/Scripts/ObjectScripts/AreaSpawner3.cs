...
public class AreaSpawner3 : MonoBehaviour
{
    ...
    private static AreaSpawner3 instance; // allows you to connnect other script to it

    // Singleton pattern to make the script accessible from other scripts
    public static AreaSpawner3 Instance // An instance to ObjectSpawnerManager
    {
        get
        {
            if (instance == null)
